...
In this course I studied sensor fusion, which is the process of taking data from multiple sensors and combining it to give us a better understanding of the world around us. we will mostly be focusing on two sensors, lidar, and radar. By the end we will be fusing the data from these two sensors to track multiple cars on the road, estimating their positions and speed.
...
![Demo](https://raw.githubusercontent.com/hedeya1980/Images/main/LiDAR_Obstacle_Detection.gif)
This is my submission for the LiDAR Obstacle Detection Project.
